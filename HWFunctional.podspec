...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "chunzhiying"
  # s.authors            = { "chunzhiying" => "chun.zhiying.ggl@gmail.com" }
  # s.social_media_url   = "http://twitter.com/chunzhiying"
  ...
  s.source       = { :git => "https://github.com/chunzhiying/HWKit.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "HWFunctionalType/**/*.{h,m}"
